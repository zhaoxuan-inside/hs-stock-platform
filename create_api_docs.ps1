...
| X-Trace-ID | 否 | string | 链路追踪ID(UUID)，不传则自动生成 |
...
| keyword | string | 否 | - | <=128字符 | 股票代码或名称关键词 |
...
Set-Content -Path "e:\HardStone.Cooding\GitHub\hs-stock-platform\docs\api-design.md